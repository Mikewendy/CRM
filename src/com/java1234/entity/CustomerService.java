...
public class CustomerService {
	...
	public String toString() {
		return "CustomerService [id=" + id + ", serveType=" + serveType
				+ ", overview=" + overview + ", customer=" + customer
				+ ", state=" + state + ", servicerequest=" + servicerequest
				+ ", createPeople=" + createPeople + ", createTime="
				+ createTime + ", assigner=" + assigner + ", assignTime="
				+ assignTime + ", serviceProce=" + serviceProce
				+ ", serviceProcePeople=" + serviceProcePeople
				+ ", serviceProceTime=" + serviceProceTime
				+ ", serviceProceResult=" + serviceProceResult + ", myd=" + myd
				+ "]";
	}
